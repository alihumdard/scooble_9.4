            ...
            <div class="col-lg-12">
              <div class="row mx-1">
                <div class="col-lg-9 px-1 py-1" style="text-align: right;">
                  <button class="btn btn-md text-white py-2" data-toggle="modal" data-target="#addclient" style="background-color: #E45F00;"><i class="fa fa-plus"></i> @lang('lang.add_client')</button>
                </div>
                <div class="col-lg-3 px-1">
                  <div class="input-group">
                    ...
                    <select name="filter_by_sts" id="filter_by_sts_client" class="form-select" style="border-left: none;">
                      <option value="">
