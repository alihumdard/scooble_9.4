            ...
            <div class="col-lg-12">
              <div class="row mx-1">
                <div class="col-lg-9" style="text-align: right;">
                  <button class="btn btn-md text-white" data-toggle="modal" data-target="#addclient" style="background-color: #E45F00; padding: 10px;"><i class="fa fa-plus"></i> @lang('lang.add_client')</button>
                </div>
