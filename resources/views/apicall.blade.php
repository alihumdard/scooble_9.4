...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-icon', function() {
            ...
            // Set the row ID as a data attribute on the modal save button
            $('#btn_address_detail').data('row-id', $(this).attr('id'));
        ...
        // updation of add address form fields
