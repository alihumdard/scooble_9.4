          ...
          <div class="col-lg-8">
            <div class="row mx-1">
              <div class="col-lg-4 px-1" style="text-align: right;">
                <button class="btn btn-md text-white" data-toggle="modal" data-target="#adduser" style="background-color: #E45F00;"><i class="fa fa-plus"></i> @lang('lang.add_user')</button>
              </div>
...
<!-- Add User Modal End -->
 ...
 <!-- Add Client Modal -->
 <div class="modal fade" style="height: 30rem;" id="confirmmodal" tabindex="-1" aria-labelledby="confirmmodalLabel" aria-hidden="true">
