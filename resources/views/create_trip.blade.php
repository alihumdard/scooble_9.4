        ...
        <div style="border: none;">
            <div class="bg-white" style="border-radius: 20px;">
                ...
                <div class="tab-content">
                    ...
                    <form action="tripStore" id="saveTrip_import" method="post" >
                            <div class="row">
                                @csrf
                                <div class="col-lg-3 my-2">
                                    <label for="title">Title:</label>
                                ...
                                <div class="col-lg-4">
                                    <label for="start_address">Start Point:</label>
                                    <select required name="start_point" id="start_point" class="form-select">
                                        @if(isset($data['start_point']) && $data['start_point'] != '')
                                        <option value="{{ $data['start_point'] }}" selected>{{ $data['start_point'] }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-lg-4 mt-4">
                                <input type="file" id="importAddress" multiple size="50"/>
                                </div>
                            </div>

                            <!-- table of address -->
                            <div class="table-responsive py-2">
                                <table id="tabe_importaddress" class="table text-center">
                                    <thead style="background-color: #E9EAEF;">
                                        <tr>
                                            <th></th>
                                            <th>@lang('lang.address')</th>
