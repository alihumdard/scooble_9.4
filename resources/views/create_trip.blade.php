...
<div class="main-panel">
            ...
            <div class="bg-white" style="border-radius: 20px;">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane container active" id="home">
                        <form action="tripStore" id="saveTrip" method="post" id="">
                            <div class="row">
                                @csrf
                                ...
                                <table id="table_address" class="table text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn p-0" id="{{$address['id']}}">
                    ...
                    <div class="tab-pane container fade" id="menu1">
                        <form action="tripStore" method="post" id="import_excel">
                            <div class="row">
                                @csrf
                                ...
                                <div class="col-lg-4 mt-4">
                                    <input type="file" class="btn text-white" style="background-color: #233A85; width: 100%; border-radius: 8px;" value="@lang('lang.import_addresses')" id="fileInput">
    ...
    <div class="modal fade" id="importmodal" tabindex="-1" role="dialog" aria-labelledby="importmodalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importmodalLabel">Import Excel.csv file here</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
