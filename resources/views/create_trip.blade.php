                    ...
                    <div class="tab-pane container fade" id="menu1">
                        <form action="storeTrip" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    <button class="btn text-white" style="background-color: #233A85; width: 100%; border-radius: 8px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3 text-center">
                        <div class="col-lg-12">
                            <button class="btn text-white" style="background-color: #233A85; width: 70%;">Confirm Location</button>
                        </div>
                    </div>
                </div>
            </div>
