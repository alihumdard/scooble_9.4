            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
             ...
             @if(view_permission('drivers'))
              ...
              <a class="dropdown-item preview-item" href="/routes">
                <div class="preview-thumbnail">
                  <div class="preview-icon">
                    <svg width="40" height="32" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M25.688 36.7278H9.00001C6.24201 36.7278 4.00001 34.4858 4.00001 31.7278C4.00001 28.9698 6.24201 26.7278 9.00001 26.7278H23C26.86 26.7278 30 23.5878 30 19.7278C30 15.8678 26.86 12.7278 23 12.7278H13.278C12.496 14.2698 11.542 15.6138 10.57 16.7278H23C24.654 16.7278 26 18.0738 26 19.7278C26 21.3818 24.654 22.7278 23 22.7278H9.00001C4.03801 22.7278 7.62939e-06 26.7658 7.62939e-06 31.7278C7.62939e-06 36.6898 4.03801 40.7278 9.00001 40.7278H28.186C27.272 39.5718 26.4 38.2338 25.688 36.7278ZM6.00001 0.727844C2.69201 0.727844 7.62939e-06 3.41984 7.62939e-06 6.72784C7.62939e-06 13.1038 6.00001 16.7278 6.00001 16.7278C6.00001 16.7278 12 13.1018 12 6.72784C12 3.41984 9.30801 0.727844 6.00001 0.727844ZM6.00001 9.72784C4.34401 9.72784 3.00001 8.38384 3.00001 6.72784C3.00001 5.07184 4.34401 3.72784 6.00001 3.72784C7.65601 3.72784 9.00001 5.07184 9.00001 6.72784C9.00001 8.38384 7.65601 9.72784 6.00001 9.72784Z" fill="#452C88" />
                      <path d="M34 24.7278C30.692 24.7278 28 27.4198 28 30.7278C28 37.1038 34 40.7278 34 40.7278C34 40.7278 40 37.1018 40 30.7278C40 27.4198 37.308 24.7278 34 24.7278ZM34 33.7278C32.344 33.7278 31 32.3838 31 30.7278C31 29.0718 32.344 27.7278 34 27.7278C35.656 27.7278 37 29.0718 37 30.7278C37 32.3838 35.656 33.7278 34 33.7278Z" fill="#452C88" />
                    </svg>
                  </div>
                </div>
                <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
              ...
              <a class="dropdown-item preview-item" href="/users">
                <div class="preview-thumbnail">
                  <div class="preview-icon">
                    <svg width="40" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M30.2333 36.0334C28.7667 36.4667 27.0333 36.6667 25 36.6667H15C12.9667 36.6667 11.2333 36.4667 9.76667 36.0334C10.1333 31.7 14.5833 28.2833 20 28.2833C25.4167 28.2833 29.8667 31.7 30.2333 36.0334Z" stroke="#452C88" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M25 3.33331H15C6.66666 3.33331 3.33333 6.66665 3.33333 15V25C3.33333 31.3 5.23333 34.75 9.76666 36.0333C10.1333 31.7 14.5833 28.2833 20 28.2833C25.4167 28.2833 29.8667 31.7 30.2333 36.0333C34.7667 34.75 36.6667 31.3 36.6667 25V15C36.6667 6.66665 33.3333 3.33331 25 3.33331ZM20 23.6166C16.7 23.6166 14.0333 20.9333 14.0333 17.6333C14.0333 14.3333 16.7 11.6666 20 11.6666C23.3 11.6666 25.9667 14.3333 25.9667 17.6333C25.9667 20.9333 23.3 23.6166 20 23.6166Z" stroke="#452C88" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M25.9667 17.6334C25.9667 20.9334 23.3 23.6167 20 23.6167C16.7 23.6167 14.0333 20.9334 14.0333 17.6334C14.0333 14.3334 16.7 11.6667 20 11.6667C23.3 11.6667 25.9667 14.3334 25.9667 17.6334Z" stroke="#452C88" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </div>
                </div>
                <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
