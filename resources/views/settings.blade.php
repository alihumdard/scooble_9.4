          ...
          <form id="formData" action="userStore" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              <div class="col-lg-12 text-center">
                ...
                <p class="error-image text-danger d-none">* Image size exceeds the limit of 1 MB.</P>
            ...
            <div class="row px-3">
              <div class="row">
                <div class="col-lg-6 mt-3">
                  <label class="mb-0" style="color: #452C88;" for="name"><b>@lang('lang.full_name')</b></label>
                  <input type="text" class="form-control" value="{{$user->name}}" name="name" id="name" placeholder="@lang('lang.enter_your_name')">
                </div>
                <div class="col-lg-6 mt-3">
                  <label class="mb-0" style="color: #452C88;" for="phone"><b>@lang('lang.phone_number')</b></label>
                ...
                <div class="col-lg-4 mt-3">
                  <label class="mb-0" style="color: #452C88;" for="confirm_password"><b>@lang('lang.confirm_password')</b></label>
...
if (file.type.startsWith('image/')) {
  if (file.size <= 1048576) {
    ...
    $('.error-image').removeClass('d-none').text('Your image size is greater then 1MB');
